export const PersonalData = [
    ...
    <p className={`pl-[100px]`}>{"},"}</p>,
    <p className={`pl-[100px]`}>contact me: {"{"}</p>, 
    <p className={`pl-[150px]`}>email: <a href="mailto:aryaan082@gmail.com">aryaan.ab.bhimani@gmail.com</a>,</p>, 
    <p className={`pl-[150px]`}>github: <a href="https://github.com/Aryaan082">aryaan082</a>,</p>, 
    <p className={`pl-[150px]`}>twitter: <a href="https://twitter.com/aryaan082">@aryaan082</a></p>, 
    <p className={`pl-[100px]`}>{"}"}</p>,
    <p className={`pl-[50px]`}>{"}"}</p>,
    `}`,
];
